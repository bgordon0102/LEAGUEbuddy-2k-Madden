...
export async function execute(interaction) {
    ...
    const coachRoleMap = JSON.parse(fs.readFileSync(path.join(__dirname, '../../../data/coachRoleMap.json'), "utf8"));
    ...
    if (teamName) {
        ...
        const rosterPath = path.join(__dirname, '../../../data/teams_rosters', fileName);
